...
class MAPPOPolicy_SecPass_multi(object):
    ...
    def __init__(self, cfg, agent_spec_dict: Dict[str, AgentSpec], device="cuda") -> None:
        ...
        self.policy_SecPass = MAPPOPolicy_mask(cfg=cfg, agent_spec=SecPass_agent_spec, device=device, mask_name=('stats', 'FirstPass_hit'))
    ...
    def train_op(self, tensordict: TensorDict):
        return self.policy_SecPass.train_op(tensordict)
